(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "@apollo/react-common", "@apollo/react-components", "@apollo/react-hoc", "@apollo/react-hooks"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("@apollo/react-common"), require("@apollo/react-components"), require("@apollo/react-hoc"), require("@apollo/react-hooks"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.reactCommon, global.reactComponents, global.reactHoc, global.reactHooks);
    global.unknown = mod.exports;
  }
})(this, function (_exports, _reactCommon, _reactComponents, _reactHoc, _reactHooks) {

  _exports.__esModule = true;
  _exports.useSubscription = _exports.useQuery = _exports.useMutation = _exports.useApolloClient = _exports.renderToStringWithData = _exports.getMarkupFromTree = _exports.getDataFromTree = _exports.withSubscription = _exports.withQuery = _exports.withMutation = _exports.withApollo = _exports.graphql = _exports.Subscription = _exports.Query = _exports.Mutation = _exports.resetApolloContext = _exports.getApolloContext = _exports.ApolloProvider = _exports.ApolloConsumer = void 0;
